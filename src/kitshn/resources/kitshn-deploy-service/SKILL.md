...
## Steps
- Verify tools: `kitshn --help`, `gh auth status`, `ssh <vps> true`.
...
- Commit only generated/edited deployment files, push, watch Actions, then run `kitshn diagnose <owner/repo> --environment <env>` on the VPS.
